...
PRODUCTS: list[tuple[str, str, str, str, str, str, str]] = [
    ...
    (
        ...
        "/assets/10-077375a3-b633-494a-844b-52967a4a1d05.png",
        "220g (7.8oz)",
        "480 kcal",
    ),
    (
    ...
    (
        ...
        "/assets/ChatGPT%20Image%20Apr%2028%2C%202026%2C%2006_42_39%20PM%20(1).png",
        "540g (19oz)",
        "160 kcal",
    ),
    (
        ...
        "Texas Tea",
        "4.49",
        "Refreshingly Delicious 100% All Natural Tea Made with Real Fruit.",
        "/assets/2.jpg",
        "540g (19oz)",
        "130 kcal",
    ),
