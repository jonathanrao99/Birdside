        ...
        <PlaceholderDoc key="privacy" title="Privacy policy">
          ...
          <section>
            ...
            <p>
              ...
              pages, and interactions with our website through cookies and
          ...
          <section>
            ...
            <p>
              ...
              messages from Birdside HTX, we may use your phone number to send
              order updates, promotional messages, cart reminders, and other
              marketing messages. Message frequency may vary. Message and data
              rates may apply. You can opt out of marketing text messages at any
              time by following the instructions included in the message, such as
              replying STOP.
            </p>
            <p>
              We use phone numbers and text message consent information only to
              operate our messaging program, send messages you requested or
              agreed to receive, maintain consent records, and comply with
              applicable laws and carrier requirements.
            </p>
          </section>
          <section>
            ...
            <p>
              ...
              help keep track of items you put into your shopping cart,
              including when you have abandoned your cart. This information may
              be used to determine when to send cart reminder messages by text
              message if you have opted in to receive text messages from us.
            </p>
          </section>
          <section>
            <h2>6. Location information</h2>
            <p>
              We may use location-related information that you provide, such as
              a delivery address, pickup location, or city suggestion, to fulfill
              orders, show relevant restaurant or service information, improve
              our location planning, and respond to requests. If our website or
              a third-party ordering or mapping tool requests precise device
          ...
          <section>
            ...
            <p>
              ...
              operate our website, process payments and orders, provide
              analytics, deliver email or text messages, prevent fraud, or
              support our business operations. These service providers are
              allowed to use information only as needed to provide services to
              us.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              remember preferences, support ordering features, measure
              performance, understand website usage, and support marketing or
              cart reminder features where permitted.
            </p>
          </section>
          <section>
            ...
            <p>
              ...
              ordering system, or transmission method is completely secure, so we
          ...
          <section>
            ...
            <p>
              ...
              out of marketing text messages by replying STOP to a message from
              us or following the instructions in the message.
            </p>
          </section>
          <section>
            <h2>11. Contact</h2>
