      ...
      mainSlots={[
        <PlaceholderDoc key="terms" title="Terms of service">
          ...
          <p>
            ...
            drinks, merchandise, catering, or related services from Birdside HTX.
            We reserve the right to decline, cancel, or limit any order for any
            reason, including product availability, suspected fraud, pricing or
            menu errors, or operational constraints. Payment must be made through
            accepted payment methods at the time required by the ordering
            channel.
          </p>
          ...
          <p>
            ...
            Birdside HTX or third-party delivery providers, and additional terms
            from those providers may apply.
          </p>
          <h2>4. Cancellations and refunds</h2>
          <p>
            Because our food is prepared fresh, cancellations may not be possible
            once preparation has started. If there is an issue with your order,
            contact us as soon as possible. Refunds, credits, replacements, or
            other remedies are handled at the discretion of Birdside HTX or the
            applicable ordering or delivery provider.
          </p>
          <h2>5. Allergens and dietary information</h2>
          <p>
            We take allergen and dietary requests seriously, but our food may be
            prepared in kitchens where common allergens are present and
            cross-contact can occur. Please review available allergen information
            and tell our team about allergies before placing an order.
          </p>
          <h2>6. Website use</h2>
          <p>
          ...
          <p>
            ...
            continued use of the Service following the effective date of any such
          ...
          <p>
            ...
            can opt out of marketing text messages at any time by following the
            instructions included in the message, such as replying STOP.
          </p>
          <h2>8. Changes to these terms</h2>
          <p>
            We may update these Terms of Service from time to time. The updated
            version will be posted on this page with the latest updated date, and
            continued use of our services after changes are posted means you
